  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between p-10 lg:p-16 bg-gray-50">
      ...
      <div className="lg:w-1/2 w-full mb-8 lg:mb-0 lg:pr-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-6 lg:text-left text-center">{translate("projectTeam")}</h1>
      ...
      <div className="lg:w-1/2 w-full flex flex-col items-center">
        ...
        />
        <h2 className="text-2xl font-semibold text-gray-800 mt-4 text-center">{translate("tatianaName")}</h2>
        <p className="text-md text-gray-600 text-center">{translate("projectLead")}</p>
      </div>
    </div>
  );
};
